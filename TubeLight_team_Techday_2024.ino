...
void loop() {
    ...
    if (btSignal == '1') Speed = 70;
    if (btSignal == '2') Speed = 80;
    if (btSignal == '3') Speed = 100;
    if (btSignal == '4') Speed = 110;
    if (btSignal == '5') Speed = 140;
...
void forward() {
  ledcWrite(rightMtrChannel1, Speed);
...
void left() {
  ledcWrite(rightMtrChannel1, 0);
  ledcWrite(rightMtrChannel2, 150);
